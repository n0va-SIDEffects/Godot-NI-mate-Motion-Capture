...
Standard ist die freigestellte Aufnahme aus ./watch (--watch
...
ASSETS = os.path.join(os.path.dirname(os.path.abspath(__file__)), "watch")
...
def main():
    ...
    p.add_argument("--watch-h", type=int, default=322,
